...
$software = "Projeções Ortogonais";

$sugestoesapplet = $_POST['objeto'];
...
$contents .= "Existe algum outro objeto que você gostaria que estivesse disponível no software, mas não está?\n";
$contents .= $sugestoesapplet;
$contents .= "\n\n";
...
$html = "<a href=\"pro-br.html\">[Clique aqui para voltar para a página principal!]</a>";
